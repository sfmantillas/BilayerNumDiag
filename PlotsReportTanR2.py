...
axs[0].semilogy(100*Coupling,[10000000*MaxEigenValImL0g0011Inf[0],10000000*MaxEigenValImL0g0021Inf[0],10000000*MaxEigenValImL0g0051Inf[0],10000000*MaxEigenValImL0g0101Inf[0]], marker='o',c=[1.0, 0.0, 0.0],ls='None',label='$a_{\\mathcal{K}}=  1$', markersize=5, linewidth=1,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])#,label='100')
axs[0].semilogy(100*Coupling,[10000000*MaxEigenValImL0g0011Inf[1],10000000*MaxEigenValImL0g0021Inf[1],10000000*MaxEigenValImL0g0051Inf[1],10000000*MaxEigenValImL0g0101Inf[1]], marker='o',c=[1.0, 0.5, 0.0],ls='None',label='$a_{\\mathcal{K}}=  2$', markersize=5, linewidth=1,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])#,label='100')
axs[0].semilogy(100*Coupling,[10000000*MaxEigenValImL0g0011Inf[2],10000000*MaxEigenValImL0g0021Inf[2],10000000*MaxEigenValImL0g0051Inf[2],10000000*MaxEigenValImL0g0101Inf[2]], marker='o',c=[0.0, 1.0, 0.0],ls='None',label='$a_{\\mathcal{K}}=  5$', markersize=5, linewidth=1,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])#,label='100')
axs[0].semilogy(100*Coupling,[10000000*MaxEigenValImL0g0011Inf[3],10000000*MaxEigenValImL0g0021Inf[3],10000000*MaxEigenValImL0g0051Inf[3],10000000*MaxEigenValImL0g0101Inf[3]], marker='o',c=[0.0, 0.0, 1.0],ls='None',label='$a_{\\mathcal{K}}= 10$', markersize=5, linewidth=1,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])#,label='100')
...
axs[0].set_ylabel('Im[$E(k)$]$/E_{\\mathrm{UV}}\\times 10^{+7}$', fontsize=12, fontname='Times New Roman')

axs[1].semilogy(100*Coupling,[10000000*MaxEigenValImL2g0011Inf[0],10000000*MaxEigenValImL2g0021Inf[0],10000000*MaxEigenValImL2g0051Inf[0],10000000*MaxEigenValImL2g0101Inf[0]], marker='o',c=[1.0, 0.0, 0.0],ls='None',label='$a_{\\mathcal{K}}= 0.01$', markersize=5, linewidth=1,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
axs[1].semilogy(100*Coupling,[10000000*MaxEigenValImL2g0011Inf[1],10000000*MaxEigenValImL2g0021Inf[1],10000000*MaxEigenValImL2g0051Inf[1],10000000*MaxEigenValImL2g0101Inf[1]], marker='o',c=[1.0, 0.5, 0.0],ls='None',label='$a_{\\mathcal{K}}= 0.02$', markersize=5, linewidth=1,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
axs[1].semilogy(100*Coupling,[10000000*MaxEigenValImL2g0011Inf[2],10000000*MaxEigenValImL2g0021Inf[2],10000000*MaxEigenValImL2g0051Inf[2],10000000*MaxEigenValImL2g0101Inf[2]], marker='o',c=[0.0, 1.0, 0.0],ls='None',label='$a_{\\mathcal{K}}= 0.05$', markersize=5, linewidth=1,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
axs[1].semilogy(100*Coupling,[10000000*MaxEigenValImL2g0011Inf[3],10000000*MaxEigenValImL2g0021Inf[3],10000000*MaxEigenValImL2g0051Inf[3],10000000*MaxEigenValImL2g0101Inf[3]], marker='o',c=[0.0, 0.0, 1.0],ls='None',label='$a_{\\mathcal{K}}= 0.10$', markersize=5, linewidth=1,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
...
axs[1].set_ylabel('Im[$E(k)$]$/E_{\\mathrm{UV}}\\times 10^{+7}$', fontsize=12, fontname='Times New Roman')
