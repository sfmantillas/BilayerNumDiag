...
sixSizes = [1./10,1./20,1./30,1./40,1./50, 0.]

def funcSizes(x, y0, slope):
    return y0 + slope *x 
...
MaxEigenValImL0g000_251Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_250011010),np.max(EigenValImL0g000_250011020),np.max(EigenValImL0g000_250011030),np.max(EigenValImL0g000_250011040),np.max(EigenValImL0g000_250011050)])
MaxEigenValImL0g000_251Inf[0] = Fit[0]
MaxEigenValImL0g000_251Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_250021010),np.max(EigenValImL0g000_250021020),np.max(EigenValImL0g000_250021030),np.max(EigenValImL0g000_250021040),np.max(EigenValImL0g000_250021050)])
MaxEigenValImL0g000_251Inf[1] = Fit[0]
MaxEigenValImL0g000_251Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_250031010),np.max(EigenValImL0g000_250031020),np.max(EigenValImL0g000_250031030),np.max(EigenValImL0g000_250031040),np.max(EigenValImL0g000_250031050)])
MaxEigenValImL0g000_251Inf[2] = Fit[0]
MaxEigenValImL0g000_251Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_250051010),np.max(EigenValImL0g000_250051020),np.max(EigenValImL0g000_250051030),np.max(EigenValImL0g000_250051040),np.max(EigenValImL0g000_250051050)])
MaxEigenValImL0g000_251Inf[3] = Fit[0]
MaxEigenValImL0g000_251Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_250071010),np.max(EigenValImL0g000_250071020),np.max(EigenValImL0g000_250071030),np.max(EigenValImL0g000_250071040),np.max(EigenValImL0g000_250071050)])
MaxEigenValImL0g000_251Inf[4] = Fit[0]
MaxEigenValImL0g000_251Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_250101010),np.max(EigenValImL0g000_250101020),np.max(EigenValImL0g000_250101030),np.max(EigenValImL0g000_250101040),np.max(EigenValImL0g000_250101050)])
MaxEigenValImL0g000_251Inf[5] = Fit[0]
MaxEigenValImL0g000_251Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK000_25.txt","w") 
print "gK0.25 aK7"
print [np.max(EigenValImL0g000_250051010),np.max(EigenValImL0g000_250051020),np.max(EigenValImL0g000_250051030),np.max(EigenValImL0g000_250051040),np.max(EigenValImL0g000_250051050),MaxEigenValImL0g000_251Inf[3]]
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 1 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_250011010),np.max(EigenValImL0g000_250011020),np.max(EigenValImL0g000_250011030),np.max(EigenValImL0g000_250011040),np.max(EigenValImL0g000_250011050),MaxEigenValImL0g000_251Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_250021010),np.max(EigenValImL0g000_250021020),np.max(EigenValImL0g000_250021030),np.max(EigenValImL0g000_250021040),np.max(EigenValImL0g000_250021050),MaxEigenValImL0g000_251Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_250031010),np.max(EigenValImL0g000_250031020),np.max(EigenValImL0g000_250031030),np.max(EigenValImL0g000_250031040),np.max(EigenValImL0g000_250031050),MaxEigenValImL0g000_251Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_250051010),np.max(EigenValImL0g000_250051020),np.max(EigenValImL0g000_250051030),np.max(EigenValImL0g000_250051040),np.max(EigenValImL0g000_250051050),MaxEigenValImL0g000_251Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_250071010),np.max(EigenValImL0g000_250071020),np.max(EigenValImL0g000_250071030),np.max(EigenValImL0g000_250071040),np.max(EigenValImL0g000_250071050),MaxEigenValImL0g000_251Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_250101010),np.max(EigenValImL0g000_250101020),np.max(EigenValImL0g000_250101030),np.max(EigenValImL0g000_250101040),np.max(EigenValImL0g000_250101050),MaxEigenValImL0g000_251Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g000_31Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_30011010),np.max(EigenValImL0g000_30011020),np.max(EigenValImL0g000_30011030),np.max(EigenValImL0g000_30011040),np.max(EigenValImL0g000_30011050)])
MaxEigenValImL0g000_31Inf[0] = Fit[0]
MaxEigenValImL0g000_31Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_30021010),np.max(EigenValImL0g000_30021020),np.max(EigenValImL0g000_30021030),np.max(EigenValImL0g000_30021040),np.max(EigenValImL0g000_30021050)])
MaxEigenValImL0g000_31Inf[1] = Fit[0]
MaxEigenValImL0g000_31Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_30031010),np.max(EigenValImL0g000_30031020),np.max(EigenValImL0g000_30031030),np.max(EigenValImL0g000_30031040),np.max(EigenValImL0g000_30031050)])
MaxEigenValImL0g000_31Inf[2] = Fit[0]
MaxEigenValImL0g000_31Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_30051010),np.max(EigenValImL0g000_30051020),np.max(EigenValImL0g000_30051030),np.max(EigenValImL0g000_30051040),np.max(EigenValImL0g000_30051050)])
MaxEigenValImL0g000_31Inf[3] = Fit[0]
MaxEigenValImL0g000_31Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_30071010),np.max(EigenValImL0g000_30071020),np.max(EigenValImL0g000_30071030),np.max(EigenValImL0g000_30071040),np.max(EigenValImL0g000_30071050)])
MaxEigenValImL0g000_31Inf[4] = Fit[0]
MaxEigenValImL0g000_31Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_30101010),np.max(EigenValImL0g000_30101020),np.max(EigenValImL0g000_30101030),np.max(EigenValImL0g000_30101040),np.max(EigenValImL0g000_30101050)])
MaxEigenValImL0g000_31Inf[5] = Fit[0]
MaxEigenValImL0g000_31Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK000_30.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_30011010),np.max(EigenValImL0g000_30011020),np.max(EigenValImL0g000_30011030),np.max(EigenValImL0g000_30011040),np.max(EigenValImL0g000_30011050),MaxEigenValImL0g000_31Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_30021010),np.max(EigenValImL0g000_30021020),np.max(EigenValImL0g000_30021030),np.max(EigenValImL0g000_30021040),np.max(EigenValImL0g000_30021050),MaxEigenValImL0g000_31Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_30031010),np.max(EigenValImL0g000_30031020),np.max(EigenValImL0g000_30031030),np.max(EigenValImL0g000_30031040),np.max(EigenValImL0g000_30031050),MaxEigenValImL0g000_31Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_30051010),np.max(EigenValImL0g000_30051020),np.max(EigenValImL0g000_30051030),np.max(EigenValImL0g000_30051040),np.max(EigenValImL0g000_30051050),MaxEigenValImL0g000_31Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_30071010),np.max(EigenValImL0g000_30071020),np.max(EigenValImL0g000_30071030),np.max(EigenValImL0g000_30071040),np.max(EigenValImL0g000_30071050),MaxEigenValImL0g000_31Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_30101010),np.max(EigenValImL0g000_30101020),np.max(EigenValImL0g000_30101030),np.max(EigenValImL0g000_30101040),np.max(EigenValImL0g000_30101050),MaxEigenValImL0g000_31Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g000_351Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_350011010),np.max(EigenValImL0g000_350011020),np.max(EigenValImL0g000_350011030),np.max(EigenValImL0g000_350011040),np.max(EigenValImL0g000_350011050)])
MaxEigenValImL0g000_351Inf[0] = Fit[0]
MaxEigenValImL0g000_351Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_350021010),np.max(EigenValImL0g000_350021020),np.max(EigenValImL0g000_350021030),np.max(EigenValImL0g000_350021040),np.max(EigenValImL0g000_350021050)])
MaxEigenValImL0g000_351Inf[1] = Fit[0]
MaxEigenValImL0g000_351Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_350031010),np.max(EigenValImL0g000_350031020),np.max(EigenValImL0g000_350031030),np.max(EigenValImL0g000_350031040),np.max(EigenValImL0g000_350031050)])
MaxEigenValImL0g000_351Inf[2] = Fit[0]
MaxEigenValImL0g000_351Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_350051010),np.max(EigenValImL0g000_350051020),np.max(EigenValImL0g000_350051030),np.max(EigenValImL0g000_350051040),np.max(EigenValImL0g000_350051050)])
MaxEigenValImL0g000_351Inf[3] = Fit[0]
MaxEigenValImL0g000_351Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_350071010),np.max(EigenValImL0g000_350071020),np.max(EigenValImL0g000_350071030),np.max(EigenValImL0g000_350071040),np.max(EigenValImL0g000_350071050)])
MaxEigenValImL0g000_351Inf[4] = Fit[0]
MaxEigenValImL0g000_351Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_350101010),np.max(EigenValImL0g000_350101020),np.max(EigenValImL0g000_350101030),np.max(EigenValImL0g000_350101040),np.max(EigenValImL0g000_350101050)])
MaxEigenValImL0g000_351Inf[5] = Fit[0]
MaxEigenValImL0g000_351Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK000_35.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_350011010),np.max(EigenValImL0g000_350011020),np.max(EigenValImL0g000_350011030),np.max(EigenValImL0g000_350011040),np.max(EigenValImL0g000_350011050),MaxEigenValImL0g000_351Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_350021010),np.max(EigenValImL0g000_350021020),np.max(EigenValImL0g000_350021030),np.max(EigenValImL0g000_350021040),np.max(EigenValImL0g000_350021050),MaxEigenValImL0g000_351Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_350031010),np.max(EigenValImL0g000_350031020),np.max(EigenValImL0g000_350031030),np.max(EigenValImL0g000_350031040),np.max(EigenValImL0g000_350031050),MaxEigenValImL0g000_351Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_350051010),np.max(EigenValImL0g000_350051020),np.max(EigenValImL0g000_350051030),np.max(EigenValImL0g000_350051040),np.max(EigenValImL0g000_350051050),MaxEigenValImL0g000_351Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_350071010),np.max(EigenValImL0g000_350071020),np.max(EigenValImL0g000_350071030),np.max(EigenValImL0g000_350071040),np.max(EigenValImL0g000_350071050),MaxEigenValImL0g000_351Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_350101010),np.max(EigenValImL0g000_350101020),np.max(EigenValImL0g000_350101030),np.max(EigenValImL0g000_350101040),np.max(EigenValImL0g000_350101050),MaxEigenValImL0g000_351Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g000_41Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_40011010),np.max(EigenValImL0g000_40011020),np.max(EigenValImL0g000_40011030),np.max(EigenValImL0g000_40011040),np.max(EigenValImL0g000_40011050)])
MaxEigenValImL0g000_41Inf[0] = Fit[0]
MaxEigenValImL0g000_41Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_40021010),np.max(EigenValImL0g000_40021020),np.max(EigenValImL0g000_40021030),np.max(EigenValImL0g000_40021040),np.max(EigenValImL0g000_40021050)])
MaxEigenValImL0g000_41Inf[1] = Fit[0]
MaxEigenValImL0g000_41Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_40031010),np.max(EigenValImL0g000_40031020),np.max(EigenValImL0g000_40031030),np.max(EigenValImL0g000_40031040),np.max(EigenValImL0g000_40031050)])
MaxEigenValImL0g000_41Inf[2] = Fit[0]
MaxEigenValImL0g000_41Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_40051010),np.max(EigenValImL0g000_40051020),np.max(EigenValImL0g000_40051030),np.max(EigenValImL0g000_40051040),np.max(EigenValImL0g000_40051050)])
MaxEigenValImL0g000_41Inf[3] = Fit[0]
MaxEigenValImL0g000_41Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_40071010),np.max(EigenValImL0g000_40071020),np.max(EigenValImL0g000_40071030),np.max(EigenValImL0g000_40071040),np.max(EigenValImL0g000_40071050)])
MaxEigenValImL0g000_41Inf[4] = Fit[0]
MaxEigenValImL0g000_41Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_40101010),np.max(EigenValImL0g000_40101020),np.max(EigenValImL0g000_40101030),np.max(EigenValImL0g000_40101040),np.max(EigenValImL0g000_40101050)])
MaxEigenValImL0g000_41Inf[5] = Fit[0]
MaxEigenValImL0g000_41Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK000_40.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_40011010),np.max(EigenValImL0g000_40011020),np.max(EigenValImL0g000_40011030),np.max(EigenValImL0g000_40011040),np.max(EigenValImL0g000_40011050),MaxEigenValImL0g000_41Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_40021010),np.max(EigenValImL0g000_40021020),np.max(EigenValImL0g000_40021030),np.max(EigenValImL0g000_40021040),np.max(EigenValImL0g000_40021050),MaxEigenValImL0g000_41Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_40031010),np.max(EigenValImL0g000_40031020),np.max(EigenValImL0g000_40031030),np.max(EigenValImL0g000_40031040),np.max(EigenValImL0g000_40031050),MaxEigenValImL0g000_41Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_40051010),np.max(EigenValImL0g000_40051020),np.max(EigenValImL0g000_40051030),np.max(EigenValImL0g000_40051040),np.max(EigenValImL0g000_40051050),MaxEigenValImL0g000_41Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_40071010),np.max(EigenValImL0g000_40071020),np.max(EigenValImL0g000_40071030),np.max(EigenValImL0g000_40071040),np.max(EigenValImL0g000_40071050),MaxEigenValImL0g000_41Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_40101010),np.max(EigenValImL0g000_40101020),np.max(EigenValImL0g000_40101030),np.max(EigenValImL0g000_40101040),np.max(EigenValImL0g000_40101050),MaxEigenValImL0g000_41Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g000_451Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_450011010),np.max(EigenValImL0g000_450011020),np.max(EigenValImL0g000_450011030),np.max(EigenValImL0g000_450011040),np.max(EigenValImL0g000_450011050)])
MaxEigenValImL0g000_451Inf[0] = Fit[0]
MaxEigenValImL0g000_451Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_450021010),np.max(EigenValImL0g000_450021020),np.max(EigenValImL0g000_450021030),np.max(EigenValImL0g000_450021040),np.max(EigenValImL0g000_450021050)])
MaxEigenValImL0g000_451Inf[1] = Fit[0]
MaxEigenValImL0g000_451Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_450031010),np.max(EigenValImL0g000_450031020),np.max(EigenValImL0g000_450031030),np.max(EigenValImL0g000_450031040),np.max(EigenValImL0g000_450031050)])
MaxEigenValImL0g000_451Inf[2] = Fit[0]
MaxEigenValImL0g000_451Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_450051010),np.max(EigenValImL0g000_450051020),np.max(EigenValImL0g000_450051030),np.max(EigenValImL0g000_450051040),np.max(EigenValImL0g000_450051050)])
MaxEigenValImL0g000_451Inf[3] = Fit[0]
MaxEigenValImL0g000_451Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_450071010),np.max(EigenValImL0g000_450071020),np.max(EigenValImL0g000_450071030),np.max(EigenValImL0g000_450071040),np.max(EigenValImL0g000_450071050)])
MaxEigenValImL0g000_451Inf[4] = Fit[0]
MaxEigenValImL0g000_451Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_450101010),np.max(EigenValImL0g000_450101020),np.max(EigenValImL0g000_450101030),np.max(EigenValImL0g000_450101040),np.max(EigenValImL0g000_450101050)])
MaxEigenValImL0g000_451Inf[5] = Fit[0]
MaxEigenValImL0g000_451Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK000_45.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_450011010),np.max(EigenValImL0g000_450011020),np.max(EigenValImL0g000_450011030),np.max(EigenValImL0g000_450011040),np.max(EigenValImL0g000_450011050),MaxEigenValImL0g000_451Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_450021010),np.max(EigenValImL0g000_450021020),np.max(EigenValImL0g000_450021030),np.max(EigenValImL0g000_450021040),np.max(EigenValImL0g000_450021050),MaxEigenValImL0g000_451Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_450031010),np.max(EigenValImL0g000_450031020),np.max(EigenValImL0g000_450031030),np.max(EigenValImL0g000_450031040),np.max(EigenValImL0g000_450031050),MaxEigenValImL0g000_451Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_450051010),np.max(EigenValImL0g000_450051020),np.max(EigenValImL0g000_450051030),np.max(EigenValImL0g000_450051040),np.max(EigenValImL0g000_450051050),MaxEigenValImL0g000_451Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_450071010),np.max(EigenValImL0g000_450071020),np.max(EigenValImL0g000_450071030),np.max(EigenValImL0g000_450071040),np.max(EigenValImL0g000_450071050),MaxEigenValImL0g000_451Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_450101010),np.max(EigenValImL0g000_450101020),np.max(EigenValImL0g000_450101030),np.max(EigenValImL0g000_450101040),np.max(EigenValImL0g000_450101050),MaxEigenValImL0g000_451Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g000_51Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_50011010),np.max(EigenValImL0g000_50011020),np.max(EigenValImL0g000_50011030),np.max(EigenValImL0g000_50011040),np.max(EigenValImL0g000_50011050)])
MaxEigenValImL0g000_51Inf[0] = Fit[0]
MaxEigenValImL0g000_51Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_50021010),np.max(EigenValImL0g000_50021020),np.max(EigenValImL0g000_50021030),np.max(EigenValImL0g000_50021040),np.max(EigenValImL0g000_50021050)])
MaxEigenValImL0g000_51Inf[1] = Fit[0]
MaxEigenValImL0g000_51Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_50031010),np.max(EigenValImL0g000_50031020),np.max(EigenValImL0g000_50031030),np.max(EigenValImL0g000_50031040),np.max(EigenValImL0g000_50031050)])
MaxEigenValImL0g000_51Inf[2] = Fit[0]
MaxEigenValImL0g000_51Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_50051010),np.max(EigenValImL0g000_50051020),np.max(EigenValImL0g000_50051030),np.max(EigenValImL0g000_50051040),np.max(EigenValImL0g000_50051050)])
MaxEigenValImL0g000_51Inf[3] = Fit[0]
MaxEigenValImL0g000_51Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_50071010),np.max(EigenValImL0g000_50071020),np.max(EigenValImL0g000_50071030),np.max(EigenValImL0g000_50071040),np.max(EigenValImL0g000_50071050)])
MaxEigenValImL0g000_51Inf[4] = Fit[0]
MaxEigenValImL0g000_51Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g000_50101010),np.max(EigenValImL0g000_50101020),np.max(EigenValImL0g000_50101030),np.max(EigenValImL0g000_50101040),np.max(EigenValImL0g000_50101050)])
MaxEigenValImL0g000_51Inf[5] = Fit[0]
MaxEigenValImL0g000_51Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK000_50.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_50011010),np.max(EigenValImL0g000_50011020),np.max(EigenValImL0g000_50011030),np.max(EigenValImL0g000_50011040),np.max(EigenValImL0g000_50011050),MaxEigenValImL0g000_51Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_50021010),np.max(EigenValImL0g000_50021020),np.max(EigenValImL0g000_50021030),np.max(EigenValImL0g000_50021040),np.max(EigenValImL0g000_50021050),MaxEigenValImL0g000_51Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_50031010),np.max(EigenValImL0g000_50031020),np.max(EigenValImL0g000_50031030),np.max(EigenValImL0g000_50031040),np.max(EigenValImL0g000_50031050),MaxEigenValImL0g000_51Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_50051010),np.max(EigenValImL0g000_50051020),np.max(EigenValImL0g000_50051030),np.max(EigenValImL0g000_50051040),np.max(EigenValImL0g000_50051050),MaxEigenValImL0g000_51Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_50071010),np.max(EigenValImL0g000_50071020),np.max(EigenValImL0g000_50071030),np.max(EigenValImL0g000_50071040),np.max(EigenValImL0g000_50071050),MaxEigenValImL0g000_51Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g000_50101010),np.max(EigenValImL0g000_50101020),np.max(EigenValImL0g000_50101030),np.max(EigenValImL0g000_50101040),np.max(EigenValImL0g000_50101050),MaxEigenValImL0g000_51Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g0011Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0010011010),np.max(EigenValImL0g0010011020),np.max(EigenValImL0g0010011030),np.max(EigenValImL0g0010011040),np.max(EigenValImL0g0010011050)])
MaxEigenValImL0g0011Inf[0] = Fit[0]
MaxEigenValImL0g0011Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0010021010),np.max(EigenValImL0g0010021020),np.max(EigenValImL0g0010021030),np.max(EigenValImL0g0010021040),np.max(EigenValImL0g0010021050)])
MaxEigenValImL0g0011Inf[1] = Fit[0]
MaxEigenValImL0g0011Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0010031010),np.max(EigenValImL0g0010031020),np.max(EigenValImL0g0010031030),np.max(EigenValImL0g0010031040),np.max(EigenValImL0g0010031050)])
MaxEigenValImL0g0011Inf[2] = Fit[0]
MaxEigenValImL0g0011Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0010051010),np.max(EigenValImL0g0010051020),np.max(EigenValImL0g0010051030),np.max(EigenValImL0g0010051040),np.max(EigenValImL0g0010051050)])
MaxEigenValImL0g0011Inf[3] = Fit[0]
MaxEigenValImL0g0011Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0010071010),np.max(EigenValImL0g0010071020),np.max(EigenValImL0g0010071030),np.max(EigenValImL0g0010071040),np.max(EigenValImL0g0010071050)])
MaxEigenValImL0g0011Inf[4] = Fit[0]
MaxEigenValImL0g0011Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0010101010),np.max(EigenValImL0g0010101020),np.max(EigenValImL0g0010101030),np.max(EigenValImL0g0010101040),np.max(EigenValImL0g0010101050)])
MaxEigenValImL0g0011Inf[5] = Fit[0]
MaxEigenValImL0g0011Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK001_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0010011010),np.max(EigenValImL0g0010011020),np.max(EigenValImL0g0010011030),np.max(EigenValImL0g0010011040),np.max(EigenValImL0g0010011050),MaxEigenValImL0g0011Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0010021010),np.max(EigenValImL0g0010021020),np.max(EigenValImL0g0010021030),np.max(EigenValImL0g0010021040),np.max(EigenValImL0g0010021050),MaxEigenValImL0g0011Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0010031010),np.max(EigenValImL0g0010031020),np.max(EigenValImL0g0010031030),np.max(EigenValImL0g0010031040),np.max(EigenValImL0g0010031050),MaxEigenValImL0g0011Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0010051010),np.max(EigenValImL0g0010051020),np.max(EigenValImL0g0010051030),np.max(EigenValImL0g0010051040),np.max(EigenValImL0g0010051050),MaxEigenValImL0g0011Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0010071010),np.max(EigenValImL0g0010071020),np.max(EigenValImL0g0010071030),np.max(EigenValImL0g0010071040),np.max(EigenValImL0g0010071050),MaxEigenValImL0g0011Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0010101010),np.max(EigenValImL0g0010101020),np.max(EigenValImL0g0010101030),np.max(EigenValImL0g0010101040),np.max(EigenValImL0g0010101050),MaxEigenValImL0g0011Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g0021Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0020011010),np.max(EigenValImL0g0020011020),np.max(EigenValImL0g0020011030),np.max(EigenValImL0g0020011040),np.max(EigenValImL0g0020011050)])
MaxEigenValImL0g0021Inf[0] = Fit[0]
MaxEigenValImL0g0021Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0020021010),np.max(EigenValImL0g0020021020),np.max(EigenValImL0g0020021030),np.max(EigenValImL0g0020021040),np.max(EigenValImL0g0020021050)])
MaxEigenValImL0g0021Inf[1] = Fit[0]
MaxEigenValImL0g0021Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0020031010),np.max(EigenValImL0g0020031020),np.max(EigenValImL0g0020031030),np.max(EigenValImL0g0020031040),np.max(EigenValImL0g0020031050)])
MaxEigenValImL0g0021Inf[2] = Fit[0]
MaxEigenValImL0g0021Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0020051010),np.max(EigenValImL0g0020051020),np.max(EigenValImL0g0020051030),np.max(EigenValImL0g0020051040),np.max(EigenValImL0g0020051050)])
MaxEigenValImL0g0021Inf[3] = Fit[0]
MaxEigenValImL0g0021Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0020071010),np.max(EigenValImL0g0020071020),np.max(EigenValImL0g0020071030),np.max(EigenValImL0g0020071040),np.max(EigenValImL0g0020071050)])
MaxEigenValImL0g0021Inf[4] = Fit[0]
MaxEigenValImL0g0021Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0020101010),np.max(EigenValImL0g0020101020),np.max(EigenValImL0g0020101030),np.max(EigenValImL0g0020101040),np.max(EigenValImL0g0020101050)])
MaxEigenValImL0g0021Inf[5] = Fit[0]
MaxEigenValImL0g0021Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK002_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0020011010),np.max(EigenValImL0g0020011020),np.max(EigenValImL0g0020011030),np.max(EigenValImL0g0020011040),np.max(EigenValImL0g0020011050),MaxEigenValImL0g0021Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0020021010),np.max(EigenValImL0g0020021020),np.max(EigenValImL0g0020021030),np.max(EigenValImL0g0020021040),np.max(EigenValImL0g0020021050),MaxEigenValImL0g0021Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0020031010),np.max(EigenValImL0g0020031020),np.max(EigenValImL0g0020031030),np.max(EigenValImL0g0020031040),np.max(EigenValImL0g0020031050),MaxEigenValImL0g0021Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0020051010),np.max(EigenValImL0g0020051020),np.max(EigenValImL0g0020051030),np.max(EigenValImL0g0020051040),np.max(EigenValImL0g0020051050),MaxEigenValImL0g0021Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0020071010),np.max(EigenValImL0g0020071020),np.max(EigenValImL0g0020071030),np.max(EigenValImL0g0020071040),np.max(EigenValImL0g0020071050),MaxEigenValImL0g0021Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0020101010),np.max(EigenValImL0g0020101020),np.max(EigenValImL0g0020101030),np.max(EigenValImL0g0020101040),np.max(EigenValImL0g0020101050),MaxEigenValImL0g0021Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g0051Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0050011010),np.max(EigenValImL0g0050011020),np.max(EigenValImL0g0050011030),np.max(EigenValImL0g0050011040),np.max(EigenValImL0g0050011050)])
MaxEigenValImL0g0051Inf[0] = Fit[0]
MaxEigenValImL0g0051Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0050021010),np.max(EigenValImL0g0050021020),np.max(EigenValImL0g0050021030),np.max(EigenValImL0g0050021040),np.max(EigenValImL0g0050021050)])
MaxEigenValImL0g0051Inf[1] = Fit[0]
MaxEigenValImL0g0051Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0050031010),np.max(EigenValImL0g0050031020),np.max(EigenValImL0g0050031030),np.max(EigenValImL0g0050031040),np.max(EigenValImL0g0050031050)])
MaxEigenValImL0g0051Inf[2] = Fit[0]
MaxEigenValImL0g0051Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0050051010),np.max(EigenValImL0g0050051020),np.max(EigenValImL0g0050051030),np.max(EigenValImL0g0050051040),np.max(EigenValImL0g0050051050)])
MaxEigenValImL0g0051Inf[3] = Fit[0]
MaxEigenValImL0g0051Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0050071010),np.max(EigenValImL0g0050071020),np.max(EigenValImL0g0050071030),np.max(EigenValImL0g0050071040),np.max(EigenValImL0g0050071050)])
MaxEigenValImL0g0051Inf[4] = Fit[0]
MaxEigenValImL0g0051Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0050101010),np.max(EigenValImL0g0050101020),np.max(EigenValImL0g0050101030),np.max(EigenValImL0g0050101040),np.max(EigenValImL0g0050101050)])
MaxEigenValImL0g0051Inf[5] = Fit[0]
MaxEigenValImL0g0051Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK005_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0050011010),np.max(EigenValImL0g0050011020),np.max(EigenValImL0g0050011030),np.max(EigenValImL0g0050011040),np.max(EigenValImL0g0050011050),MaxEigenValImL0g0051Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0050021010),np.max(EigenValImL0g0050021020),np.max(EigenValImL0g0050021030),np.max(EigenValImL0g0050021040),np.max(EigenValImL0g0050021050),MaxEigenValImL0g0051Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0050031010),np.max(EigenValImL0g0050031020),np.max(EigenValImL0g0050031030),np.max(EigenValImL0g0050031040),np.max(EigenValImL0g0050031050),MaxEigenValImL0g0051Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0050051010),np.max(EigenValImL0g0050051020),np.max(EigenValImL0g0050051030),np.max(EigenValImL0g0050051040),np.max(EigenValImL0g0050051050),MaxEigenValImL0g0051Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0050071010),np.max(EigenValImL0g0050071020),np.max(EigenValImL0g0050071030),np.max(EigenValImL0g0050071040),np.max(EigenValImL0g0050071050),MaxEigenValImL0g0051Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0050101010),np.max(EigenValImL0g0050101020),np.max(EigenValImL0g0050101030),np.max(EigenValImL0g0050101040),np.max(EigenValImL0g0050101050),MaxEigenValImL0g0051Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL0g0101Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0100011010),np.max(EigenValImL0g0100011020),np.max(EigenValImL0g0100011030),np.max(EigenValImL0g0100011040),np.max(EigenValImL0g0100011050)])
MaxEigenValImL0g0101Inf[0] = Fit[0]
MaxEigenValImL0g0101Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0100021010),np.max(EigenValImL0g0100021020),np.max(EigenValImL0g0100021030),np.max(EigenValImL0g0100021040),np.max(EigenValImL0g0100021050)])
MaxEigenValImL0g0101Inf[1] = Fit[0]
MaxEigenValImL0g0101Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0100031010),np.max(EigenValImL0g0100031020),np.max(EigenValImL0g0100031030),np.max(EigenValImL0g0100031040),np.max(EigenValImL0g0100031050)])
MaxEigenValImL0g0101Inf[2] = Fit[0]
MaxEigenValImL0g0101Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0100051010),np.max(EigenValImL0g0100051020),np.max(EigenValImL0g0100051030),np.max(EigenValImL0g0100051040),np.max(EigenValImL0g0100051050)])
MaxEigenValImL0g0101Inf[3] = Fit[0]
MaxEigenValImL0g0101Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0100071010),np.max(EigenValImL0g0100071020),np.max(EigenValImL0g0100071030),np.max(EigenValImL0g0100071040),np.max(EigenValImL0g0100071050)])
MaxEigenValImL0g0101Inf[4] = Fit[0]
MaxEigenValImL0g0101Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL0g0100101010),np.max(EigenValImL0g0100101020),np.max(EigenValImL0g0100101030),np.max(EigenValImL0g0100101040),np.max(EigenValImL0g0100101050)])
MaxEigenValImL0g0101Inf[5] = Fit[0]
MaxEigenValImL0g0101Err[5] = np.sqrt( Cov[0,0] )

file = open("L0gK010_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0100011010),np.max(EigenValImL0g0100011020),np.max(EigenValImL0g0100011030),np.max(EigenValImL0g0100011040),np.max(EigenValImL0g0100011050),MaxEigenValImL0g0101Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0100021010),np.max(EigenValImL0g0100021020),np.max(EigenValImL0g0100021030),np.max(EigenValImL0g0100021040),np.max(EigenValImL0g0100021050),MaxEigenValImL0g0101Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0100031010),np.max(EigenValImL0g0100031020),np.max(EigenValImL0g0100031030),np.max(EigenValImL0g0100031040),np.max(EigenValImL0g0100031050),MaxEigenValImL0g0101Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0100051010),np.max(EigenValImL0g0100051020),np.max(EigenValImL0g0100051030),np.max(EigenValImL0g0100051040),np.max(EigenValImL0g0100051050),MaxEigenValImL0g0101Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0100071010),np.max(EigenValImL0g0100071020),np.max(EigenValImL0g0100071030),np.max(EigenValImL0g0100071040),np.max(EigenValImL0g0100071050),MaxEigenValImL0g0101Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL0g0100101010),np.max(EigenValImL0g0100101020),np.max(EigenValImL0g0100101030),np.max(EigenValImL0g0100101040),np.max(EigenValImL0g0100101050),MaxEigenValImL0g0101Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g000_51Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_50011010),np.max(EigenValImL2g000_50011020),np.max(EigenValImL2g000_50011030),np.max(EigenValImL2g000_50011040),np.max(EigenValImL2g000_50011050)])
MaxEigenValImL2g000_51Inf[0] = Fit[0]
MaxEigenValImL2g000_51Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_50021010),np.max(EigenValImL2g000_50021020),np.max(EigenValImL2g000_50021030),np.max(EigenValImL2g000_50021040),np.max(EigenValImL2g000_50021050)])
MaxEigenValImL2g000_51Inf[1] = Fit[0]
MaxEigenValImL2g000_51Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_50031010),np.max(EigenValImL2g000_50031020),np.max(EigenValImL2g000_50031030),np.max(EigenValImL2g000_50031040),np.max(EigenValImL2g000_50031050)])
MaxEigenValImL2g000_51Inf[2] = Fit[0]
MaxEigenValImL2g000_51Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_50051010),np.max(EigenValImL2g000_50051020),np.max(EigenValImL2g000_50051030),np.max(EigenValImL2g000_50051040),np.max(EigenValImL2g000_50051050)])
MaxEigenValImL2g000_51Inf[3] = Fit[0]
MaxEigenValImL2g000_51Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_50071010),np.max(EigenValImL2g000_50071020),np.max(EigenValImL2g000_50071030),np.max(EigenValImL2g000_50071040),np.max(EigenValImL2g000_50071050)])
MaxEigenValImL2g000_51Inf[4] = Fit[0]
MaxEigenValImL2g000_51Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_50101010),np.max(EigenValImL2g000_50101020),np.max(EigenValImL2g000_50101030),np.max(EigenValImL2g000_50101040),np.max(EigenValImL2g000_50101050)])
MaxEigenValImL2g000_51Inf[5] = Fit[0]
MaxEigenValImL2g000_51Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK000_50.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_50011010),np.max(EigenValImL2g000_50011020),np.max(EigenValImL2g000_50011030),np.max(EigenValImL2g000_50011040),np.max(EigenValImL2g000_50011050),MaxEigenValImL2g000_51Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_50021010),np.max(EigenValImL2g000_50021020),np.max(EigenValImL2g000_50021030),np.max(EigenValImL2g000_50021040),np.max(EigenValImL2g000_50021050),MaxEigenValImL2g000_51Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_50031010),np.max(EigenValImL2g000_50031020),np.max(EigenValImL2g000_50031030),np.max(EigenValImL2g000_50031040),np.max(EigenValImL2g000_50031050),MaxEigenValImL2g000_51Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_50051010),np.max(EigenValImL2g000_50051020),np.max(EigenValImL2g000_50051030),np.max(EigenValImL2g000_50051040),np.max(EigenValImL2g000_50051050),MaxEigenValImL2g000_51Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_50071010),np.max(EigenValImL2g000_50071020),np.max(EigenValImL2g000_50071030),np.max(EigenValImL2g000_50071040),np.max(EigenValImL2g000_50071050),MaxEigenValImL2g000_51Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_50101010),np.max(EigenValImL2g000_50101020),np.max(EigenValImL2g000_50101030),np.max(EigenValImL2g000_50101040),np.max(EigenValImL2g000_50101050),MaxEigenValImL2g000_51Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g000_61Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_60011010),np.max(EigenValImL2g000_60011020),np.max(EigenValImL2g000_60011030),np.max(EigenValImL2g000_60011040),np.max(EigenValImL2g000_60011050)])
MaxEigenValImL2g000_61Inf[0] = Fit[0]
MaxEigenValImL2g000_61Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_60021010),np.max(EigenValImL2g000_60021020),np.max(EigenValImL2g000_60021030),np.max(EigenValImL2g000_60021040),np.max(EigenValImL2g000_60021050)])
MaxEigenValImL2g000_61Inf[1] = Fit[0]
MaxEigenValImL2g000_61Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_60031010),np.max(EigenValImL2g000_60031020),np.max(EigenValImL2g000_60031030),np.max(EigenValImL2g000_60031040),np.max(EigenValImL2g000_60031050)])
MaxEigenValImL2g000_61Inf[2] = Fit[0]
MaxEigenValImL2g000_61Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_60051010),np.max(EigenValImL2g000_60051020),np.max(EigenValImL2g000_60051030),np.max(EigenValImL2g000_60051040),np.max(EigenValImL2g000_60051050)])
MaxEigenValImL2g000_61Inf[3] = Fit[0]
MaxEigenValImL2g000_61Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_60071010),np.max(EigenValImL2g000_60071020),np.max(EigenValImL2g000_60071030),np.max(EigenValImL2g000_60071040),np.max(EigenValImL2g000_60071050)])
MaxEigenValImL2g000_61Inf[4] = Fit[0]
MaxEigenValImL2g000_61Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_60101010),np.max(EigenValImL2g000_60101020),np.max(EigenValImL2g000_60101030),np.max(EigenValImL2g000_60101040),np.max(EigenValImL2g000_60101050)])
MaxEigenValImL2g000_61Inf[5] = Fit[0]
MaxEigenValImL2g000_61Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK000_60.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_60011010),np.max(EigenValImL2g000_60011020),np.max(EigenValImL2g000_60011030),np.max(EigenValImL2g000_60011040),np.max(EigenValImL2g000_60011050),MaxEigenValImL2g000_61Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_60021010),np.max(EigenValImL2g000_60021020),np.max(EigenValImL2g000_60021030),np.max(EigenValImL2g000_60021040),np.max(EigenValImL2g000_60021050),MaxEigenValImL2g000_61Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_60031010),np.max(EigenValImL2g000_60031020),np.max(EigenValImL2g000_60031030),np.max(EigenValImL2g000_60031040),np.max(EigenValImL2g000_60031050),MaxEigenValImL2g000_61Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_60051010),np.max(EigenValImL2g000_60051020),np.max(EigenValImL2g000_60051030),np.max(EigenValImL2g000_60051040),np.max(EigenValImL2g000_60051050),MaxEigenValImL2g000_61Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_60071010),np.max(EigenValImL2g000_60071020),np.max(EigenValImL2g000_60071030),np.max(EigenValImL2g000_60071040),np.max(EigenValImL2g000_60071050),MaxEigenValImL2g000_61Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_60101010),np.max(EigenValImL2g000_60101020),np.max(EigenValImL2g000_60101030),np.max(EigenValImL2g000_60101040),np.max(EigenValImL2g000_60101050),MaxEigenValImL2g000_61Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g000_71Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_70011010),np.max(EigenValImL2g000_70011020),np.max(EigenValImL2g000_70011030),np.max(EigenValImL2g000_70011040),np.max(EigenValImL2g000_70011050)])
MaxEigenValImL2g000_71Inf[0] = Fit[0]
MaxEigenValImL2g000_71Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_70021010),np.max(EigenValImL2g000_70021020),np.max(EigenValImL2g000_70021030),np.max(EigenValImL2g000_70021040),np.max(EigenValImL2g000_70021050)])
MaxEigenValImL2g000_71Inf[1] = Fit[0]
MaxEigenValImL2g000_71Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_70031010),np.max(EigenValImL2g000_70031020),np.max(EigenValImL2g000_70031030),np.max(EigenValImL2g000_70031040),np.max(EigenValImL2g000_70031050)])
MaxEigenValImL2g000_71Inf[2] = Fit[0]
MaxEigenValImL2g000_71Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_70051010),np.max(EigenValImL2g000_70051020),np.max(EigenValImL2g000_70051030),np.max(EigenValImL2g000_70051040),np.max(EigenValImL2g000_70051050)])
MaxEigenValImL2g000_71Inf[3] = Fit[0]
MaxEigenValImL2g000_71Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_70071010),np.max(EigenValImL2g000_70071020),np.max(EigenValImL2g000_70071030),np.max(EigenValImL2g000_70071040),np.max(EigenValImL2g000_70071050)])
MaxEigenValImL2g000_71Inf[4] = Fit[0]
MaxEigenValImL2g000_71Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_70101010),np.max(EigenValImL2g000_70101020),np.max(EigenValImL2g000_70101030),np.max(EigenValImL2g000_70101040),np.max(EigenValImL2g000_70101050)])
MaxEigenValImL2g000_71Inf[5] = Fit[0]
MaxEigenValImL2g000_71Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK000_70.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_70011010),np.max(EigenValImL2g000_70011020),np.max(EigenValImL2g000_70011030),np.max(EigenValImL2g000_70011040),np.max(EigenValImL2g000_70011050),MaxEigenValImL2g000_71Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_70021010),np.max(EigenValImL2g000_70021020),np.max(EigenValImL2g000_70021030),np.max(EigenValImL2g000_70021040),np.max(EigenValImL2g000_70021050),MaxEigenValImL2g000_71Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_70031010),np.max(EigenValImL2g000_70031020),np.max(EigenValImL2g000_70031030),np.max(EigenValImL2g000_70031040),np.max(EigenValImL2g000_70031050),MaxEigenValImL2g000_71Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_70051010),np.max(EigenValImL2g000_70051020),np.max(EigenValImL2g000_70051030),np.max(EigenValImL2g000_70051040),np.max(EigenValImL2g000_70051050),MaxEigenValImL2g000_71Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_70071010),np.max(EigenValImL2g000_70071020),np.max(EigenValImL2g000_70071030),np.max(EigenValImL2g000_70071040),np.max(EigenValImL2g000_70071050),MaxEigenValImL2g000_71Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_70101010),np.max(EigenValImL2g000_70101020),np.max(EigenValImL2g000_70101030),np.max(EigenValImL2g000_70101040),np.max(EigenValImL2g000_70101050),MaxEigenValImL2g000_71Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g000_81Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_80011010),np.max(EigenValImL2g000_80011020),np.max(EigenValImL2g000_80011030),np.max(EigenValImL2g000_80011040),np.max(EigenValImL2g000_80011050)])
MaxEigenValImL2g000_81Inf[0] = Fit[0]
MaxEigenValImL2g000_81Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_80021010),np.max(EigenValImL2g000_80021020),np.max(EigenValImL2g000_80021030),np.max(EigenValImL2g000_80021040),np.max(EigenValImL2g000_80021050)])
MaxEigenValImL2g000_81Inf[1] = Fit[0]
MaxEigenValImL2g000_81Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_80031010),np.max(EigenValImL2g000_80031020),np.max(EigenValImL2g000_80031030),np.max(EigenValImL2g000_80031040),np.max(EigenValImL2g000_80031050)])
MaxEigenValImL2g000_81Inf[2] = Fit[0]
MaxEigenValImL2g000_81Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_80051010),np.max(EigenValImL2g000_80051020),np.max(EigenValImL2g000_80051030),np.max(EigenValImL2g000_80051040),np.max(EigenValImL2g000_80051050)])
MaxEigenValImL2g000_81Inf[3] = Fit[0]
MaxEigenValImL2g000_81Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_80071010),np.max(EigenValImL2g000_80071020),np.max(EigenValImL2g000_80071030),np.max(EigenValImL2g000_80071040),np.max(EigenValImL2g000_80071050)])
MaxEigenValImL2g000_81Inf[4] = Fit[0]
MaxEigenValImL2g000_81Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_80101010),np.max(EigenValImL2g000_80101020),np.max(EigenValImL2g000_80101030),np.max(EigenValImL2g000_80101040),np.max(EigenValImL2g000_80101050)])
MaxEigenValImL2g000_81Inf[5] = Fit[0]
MaxEigenValImL2g000_81Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK000_80.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_80011010),np.max(EigenValImL2g000_80011020),np.max(EigenValImL2g000_80011030),np.max(EigenValImL2g000_80011040),np.max(EigenValImL2g000_80011050),MaxEigenValImL2g000_81Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_80021010),np.max(EigenValImL2g000_80021020),np.max(EigenValImL2g000_80021030),np.max(EigenValImL2g000_80021040),np.max(EigenValImL2g000_80021050),MaxEigenValImL2g000_81Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_80031010),np.max(EigenValImL2g000_80031020),np.max(EigenValImL2g000_80031030),np.max(EigenValImL2g000_80031040),np.max(EigenValImL2g000_80031050),MaxEigenValImL2g000_81Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_80051010),np.max(EigenValImL2g000_80051020),np.max(EigenValImL2g000_80051030),np.max(EigenValImL2g000_80051040),np.max(EigenValImL2g000_80051050),MaxEigenValImL2g000_81Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_80071010),np.max(EigenValImL2g000_80071020),np.max(EigenValImL2g000_80071030),np.max(EigenValImL2g000_80071040),np.max(EigenValImL2g000_80071050),MaxEigenValImL2g000_81Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_80101010),np.max(EigenValImL2g000_80101020),np.max(EigenValImL2g000_80101030),np.max(EigenValImL2g000_80101040),np.max(EigenValImL2g000_80101050),MaxEigenValImL2g000_81Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g000_91Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_90011010),np.max(EigenValImL2g000_90011020),np.max(EigenValImL2g000_90011030),np.max(EigenValImL2g000_90011040),np.max(EigenValImL2g000_90011050)])
MaxEigenValImL2g000_91Inf[0] = Fit[0]
MaxEigenValImL2g000_91Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_90021010),np.max(EigenValImL2g000_90021020),np.max(EigenValImL2g000_90021030),np.max(EigenValImL2g000_90021040),np.max(EigenValImL2g000_90021050)])
MaxEigenValImL2g000_91Inf[1] = Fit[0]
MaxEigenValImL2g000_91Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_90031010),np.max(EigenValImL2g000_90031020),np.max(EigenValImL2g000_90031030),np.max(EigenValImL2g000_90031040),np.max(EigenValImL2g000_90031050)])
MaxEigenValImL2g000_91Inf[2] = Fit[0]
MaxEigenValImL2g000_91Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_90051010),np.max(EigenValImL2g000_90051020),np.max(EigenValImL2g000_90051030),np.max(EigenValImL2g000_90051040),np.max(EigenValImL2g000_90051050)])
MaxEigenValImL2g000_91Inf[3] = Fit[0]
MaxEigenValImL2g000_91Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_90071010),np.max(EigenValImL2g000_90071020),np.max(EigenValImL2g000_90071030),np.max(EigenValImL2g000_90071040),np.max(EigenValImL2g000_90071050)])
MaxEigenValImL2g000_91Inf[4] = Fit[0]
MaxEigenValImL2g000_91Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g000_90101010),np.max(EigenValImL2g000_90101020),np.max(EigenValImL2g000_90101030),np.max(EigenValImL2g000_90101040),np.max(EigenValImL2g000_90101050)])
MaxEigenValImL2g000_91Inf[5] = Fit[0]
MaxEigenValImL2g000_91Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK000_90.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_90011010),np.max(EigenValImL2g000_90011020),np.max(EigenValImL2g000_90011030),np.max(EigenValImL2g000_90011040),np.max(EigenValImL2g000_90011050),MaxEigenValImL2g000_91Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_90021010),np.max(EigenValImL2g000_90021020),np.max(EigenValImL2g000_90021030),np.max(EigenValImL2g000_90021040),np.max(EigenValImL2g000_90021050),MaxEigenValImL2g000_91Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_90031010),np.max(EigenValImL2g000_90031020),np.max(EigenValImL2g000_90031030),np.max(EigenValImL2g000_90031040),np.max(EigenValImL2g000_90031050),MaxEigenValImL2g000_91Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_90051010),np.max(EigenValImL2g000_90051020),np.max(EigenValImL2g000_90051030),np.max(EigenValImL2g000_90051040),np.max(EigenValImL2g000_90051050),MaxEigenValImL2g000_91Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_90071010),np.max(EigenValImL2g000_90071020),np.max(EigenValImL2g000_90071030),np.max(EigenValImL2g000_90071040),np.max(EigenValImL2g000_90071050),MaxEigenValImL2g000_91Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g000_90101010),np.max(EigenValImL2g000_90101020),np.max(EigenValImL2g000_90101030),np.max(EigenValImL2g000_90101040),np.max(EigenValImL2g000_90101050),MaxEigenValImL2g000_91Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g0011Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0010011010),np.max(EigenValImL2g0010011020),np.max(EigenValImL2g0010011030),np.max(EigenValImL2g0010011040),np.max(EigenValImL2g0010011050)])
MaxEigenValImL2g0011Inf[0] = Fit[0]
MaxEigenValImL2g0011Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0010021010),np.max(EigenValImL2g0010021020),np.max(EigenValImL2g0010021030),np.max(EigenValImL2g0010021040),np.max(EigenValImL2g0010021050)])
MaxEigenValImL2g0011Inf[1] = Fit[0]
MaxEigenValImL2g0011Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0010031010),np.max(EigenValImL2g0010031020),np.max(EigenValImL2g0010031030),np.max(EigenValImL2g0010031040),np.max(EigenValImL2g0010031050)])
MaxEigenValImL2g0011Inf[2] = Fit[0]
MaxEigenValImL2g0011Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0010051010),np.max(EigenValImL2g0010051020),np.max(EigenValImL2g0010051030),np.max(EigenValImL2g0010051040),np.max(EigenValImL2g0010051050)])
MaxEigenValImL2g0011Inf[3] = Fit[0]
MaxEigenValImL2g0011Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0010071010),np.max(EigenValImL2g0010071020),np.max(EigenValImL2g0010071030),np.max(EigenValImL2g0010071040),np.max(EigenValImL2g0010071050)])
MaxEigenValImL2g0011Inf[4] = Fit[0]
MaxEigenValImL2g0011Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0010101010),np.max(EigenValImL2g0010101020),np.max(EigenValImL2g0010101030),np.max(EigenValImL2g0010101040),np.max(EigenValImL2g0010101050)])
MaxEigenValImL2g0011Inf[5] = Fit[0]
MaxEigenValImL2g0011Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK001_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0010011010),np.max(EigenValImL2g0010011020),np.max(EigenValImL2g0010011030),np.max(EigenValImL2g0010011040),np.max(EigenValImL2g0010011050),MaxEigenValImL2g0011Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0010021010),np.max(EigenValImL2g0010021020),np.max(EigenValImL2g0010021030),np.max(EigenValImL2g0010021040),np.max(EigenValImL2g0010021050),MaxEigenValImL2g0011Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0010031010),np.max(EigenValImL2g0010031020),np.max(EigenValImL2g0010031030),np.max(EigenValImL2g0010031040),np.max(EigenValImL2g0010031050),MaxEigenValImL2g0011Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0010051010),np.max(EigenValImL2g0010051020),np.max(EigenValImL2g0010051030),np.max(EigenValImL2g0010051040),np.max(EigenValImL2g0010051050),MaxEigenValImL2g0011Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0010071010),np.max(EigenValImL2g0010071020),np.max(EigenValImL2g0010071030),np.max(EigenValImL2g0010071040),np.max(EigenValImL2g0010071050),MaxEigenValImL2g0011Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0010101010),np.max(EigenValImL2g0010101020),np.max(EigenValImL2g0010101030),np.max(EigenValImL2g0010101040),np.max(EigenValImL2g0010101050),MaxEigenValImL2g0011Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g0021Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0020011010),np.max(EigenValImL2g0020011020),np.max(EigenValImL2g0020011030),np.max(EigenValImL2g0020011040),np.max(EigenValImL2g0020011050)])
MaxEigenValImL2g0021Inf[0] = Fit[0]
MaxEigenValImL2g0021Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0020021010),np.max(EigenValImL2g0020021020),np.max(EigenValImL2g0020021030),np.max(EigenValImL2g0020021040),np.max(EigenValImL2g0020021050)])
MaxEigenValImL2g0021Inf[1] = Fit[0]
MaxEigenValImL2g0021Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0020031010),np.max(EigenValImL2g0020031020),np.max(EigenValImL2g0020031030),np.max(EigenValImL2g0020031040),np.max(EigenValImL2g0020031050)])
MaxEigenValImL2g0021Inf[2] = Fit[0]
MaxEigenValImL2g0021Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0020051010),np.max(EigenValImL2g0020051020),np.max(EigenValImL2g0020051030),np.max(EigenValImL2g0020051040),np.max(EigenValImL2g0020051050)])
MaxEigenValImL2g0021Inf[3] = Fit[0]
MaxEigenValImL2g0021Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0020071010),np.max(EigenValImL2g0020071020),np.max(EigenValImL2g0020071030),np.max(EigenValImL2g0020071040),np.max(EigenValImL2g0020071050)])
MaxEigenValImL2g0021Inf[4] = Fit[0]
MaxEigenValImL2g0021Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0020101010),np.max(EigenValImL2g0020101020),np.max(EigenValImL2g0020101030),np.max(EigenValImL2g0020101040),np.max(EigenValImL2g0020101050)])
MaxEigenValImL2g0021Inf[5] = Fit[0]
MaxEigenValImL2g0021Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK002_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0020011010),np.max(EigenValImL2g0020011020),np.max(EigenValImL2g0020011030),np.max(EigenValImL2g0020011040),np.max(EigenValImL2g0020011050),MaxEigenValImL2g0021Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0020021010),np.max(EigenValImL2g0020021020),np.max(EigenValImL2g0020021030),np.max(EigenValImL2g0020021040),np.max(EigenValImL2g0020021050),MaxEigenValImL2g0021Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0020031010),np.max(EigenValImL2g0020031020),np.max(EigenValImL2g0020031030),np.max(EigenValImL2g0020031040),np.max(EigenValImL2g0020031050),MaxEigenValImL2g0021Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0020051010),np.max(EigenValImL2g0020051020),np.max(EigenValImL2g0020051030),np.max(EigenValImL2g0020051040),np.max(EigenValImL2g0020051050),MaxEigenValImL2g0021Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0020071010),np.max(EigenValImL2g0020071020),np.max(EigenValImL2g0020071030),np.max(EigenValImL2g0020071040),np.max(EigenValImL2g0020071050),MaxEigenValImL2g0021Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0020101010),np.max(EigenValImL2g0020101020),np.max(EigenValImL2g0020101030),np.max(EigenValImL2g0020101040),np.max(EigenValImL2g0020101050),MaxEigenValImL2g0021Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g0051Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0050011010),np.max(EigenValImL2g0050011020),np.max(EigenValImL2g0050011030),np.max(EigenValImL2g0050011040),np.max(EigenValImL2g0050011050)])
MaxEigenValImL2g0051Inf[0] = Fit[0]
MaxEigenValImL2g0051Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0050021010),np.max(EigenValImL2g0050021020),np.max(EigenValImL2g0050021030),np.max(EigenValImL2g0050021040),np.max(EigenValImL2g0050021050)])
MaxEigenValImL2g0051Inf[1] = Fit[0]
MaxEigenValImL2g0051Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0050031010),np.max(EigenValImL2g0050031020),np.max(EigenValImL2g0050031030),np.max(EigenValImL2g0050031040),np.max(EigenValImL2g0050031050)])
MaxEigenValImL2g0051Inf[2] = Fit[0]
MaxEigenValImL2g0051Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0050051010),np.max(EigenValImL2g0050051020),np.max(EigenValImL2g0050051030),np.max(EigenValImL2g0050051040),np.max(EigenValImL2g0050051050)])
MaxEigenValImL2g0051Inf[3] = Fit[0]
MaxEigenValImL2g0051Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0050071010),np.max(EigenValImL2g0050071020),np.max(EigenValImL2g0050071030),np.max(EigenValImL2g0050071040),np.max(EigenValImL2g0050071050)])
MaxEigenValImL2g0051Inf[4] = Fit[0]
MaxEigenValImL2g0051Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0050101010),np.max(EigenValImL2g0050101020),np.max(EigenValImL2g0050101030),np.max(EigenValImL2g0050101040),np.max(EigenValImL2g0050101050)])
MaxEigenValImL2g0051Inf[5] = Fit[0]
MaxEigenValImL2g0051Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK005_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0050011010),np.max(EigenValImL2g0050011020),np.max(EigenValImL2g0050011030),np.max(EigenValImL2g0050011040),np.max(EigenValImL2g0050011050),MaxEigenValImL2g0051Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0050021010),np.max(EigenValImL2g0050021020),np.max(EigenValImL2g0050021030),np.max(EigenValImL2g0050021040),np.max(EigenValImL2g0050021050),MaxEigenValImL2g0051Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0050031010),np.max(EigenValImL2g0050031020),np.max(EigenValImL2g0050031030),np.max(EigenValImL2g0050031040),np.max(EigenValImL2g0050031050),MaxEigenValImL2g0051Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0050051010),np.max(EigenValImL2g0050051020),np.max(EigenValImL2g0050051030),np.max(EigenValImL2g0050051040),np.max(EigenValImL2g0050051050),MaxEigenValImL2g0051Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0050071010),np.max(EigenValImL2g0050071020),np.max(EigenValImL2g0050071030),np.max(EigenValImL2g0050071040),np.max(EigenValImL2g0050071050),MaxEigenValImL2g0051Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0050101010),np.max(EigenValImL2g0050101020),np.max(EigenValImL2g0050101030),np.max(EigenValImL2g0050101040),np.max(EigenValImL2g0050101050),MaxEigenValImL2g0051Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
MaxEigenValImL2g0101Err = np.zeros((6))

Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0100011010),np.max(EigenValImL2g0100011020),np.max(EigenValImL2g0100011030),np.max(EigenValImL2g0100011040),np.max(EigenValImL2g0100011050)])
MaxEigenValImL2g0101Inf[0] = Fit[0]
MaxEigenValImL2g0101Err[0] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0100021010),np.max(EigenValImL2g0100021020),np.max(EigenValImL2g0100021030),np.max(EigenValImL2g0100021040),np.max(EigenValImL2g0100021050)])
MaxEigenValImL2g0101Inf[1] = Fit[0]
MaxEigenValImL2g0101Err[1] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0100031010),np.max(EigenValImL2g0100031020),np.max(EigenValImL2g0100031030),np.max(EigenValImL2g0100031040),np.max(EigenValImL2g0100031050)])
MaxEigenValImL2g0101Inf[2] = Fit[0]
MaxEigenValImL2g0101Err[2] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0100051010),np.max(EigenValImL2g0100051020),np.max(EigenValImL2g0100051030),np.max(EigenValImL2g0100051040),np.max(EigenValImL2g0100051050)])
MaxEigenValImL2g0101Inf[3] = Fit[0]
MaxEigenValImL2g0101Err[3] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0100071010),np.max(EigenValImL2g0100071020),np.max(EigenValImL2g0100071030),np.max(EigenValImL2g0100071040),np.max(EigenValImL2g0100071050)])
MaxEigenValImL2g0101Inf[4] = Fit[0]
MaxEigenValImL2g0101Err[4] = np.sqrt( Cov[0,0] )
Fit, Cov = curve_fit(funcSizes, fiveSizes, [np.max(EigenValImL2g0100101010),np.max(EigenValImL2g0100101020),np.max(EigenValImL2g0100101030),np.max(EigenValImL2g0100101040),np.max(EigenValImL2g0100101050)])
MaxEigenValImL2g0101Inf[5] = Fit[0]
MaxEigenValImL2g0101Err[5] = np.sqrt( Cov[0,0] )

file = open("L2gK010_00.txt","w") 
...
for m1 in range(0,len(sixSizes)):
    ...
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0100011010),np.max(EigenValImL2g0100011020),np.max(EigenValImL2g0100011030),np.max(EigenValImL2g0100011040),np.max(EigenValImL2g0100011050),MaxEigenValImL2g0101Inf[0]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 2 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0100021010),np.max(EigenValImL2g0100021020),np.max(EigenValImL2g0100021030),np.max(EigenValImL2g0100021040),np.max(EigenValImL2g0100021050),MaxEigenValImL2g0101Inf[1]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 3 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0100031010),np.max(EigenValImL2g0100031020),np.max(EigenValImL2g0100031030),np.max(EigenValImL2g0100031040),np.max(EigenValImL2g0100031050),MaxEigenValImL2g0101Inf[2]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 5 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0100051010),np.max(EigenValImL2g0100051020),np.max(EigenValImL2g0100051030),np.max(EigenValImL2g0100051040),np.max(EigenValImL2g0100051050),MaxEigenValImL2g0101Inf[3]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 7 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0100071010),np.max(EigenValImL2g0100071020),np.max(EigenValImL2g0100071030),np.max(EigenValImL2g0100071040),np.max(EigenValImL2g0100071050),MaxEigenValImL2g0101Inf[4]][m1] ))
    file.write('\n'),
for m1 in range(0,len(sixSizes)):
    file.write("%s" % ( 10 )),
    file.write("\t"),
    file.write("%s" % ( sixSizes[m1] ))
    file.write("\t"),
    file.write("%s" % ( [np.max(EigenValImL2g0100101010),np.max(EigenValImL2g0100101020),np.max(EigenValImL2g0100101030),np.max(EigenValImL2g0100101040),np.max(EigenValImL2g0100101050),MaxEigenValImL2g0101Inf[5]][m1] ))
    file.write('\n'),
file.close() 
...
print MaxEigenValImL0aK007Total
print MaxEigenValImL0aK010Total
...
MaxEigenValImL0aK001Err = np.zeros(( len(CouplingB) ))
MaxEigenValImL0aK002Err = np.zeros(( len(CouplingB) ))
MaxEigenValImL0aK003Err = np.zeros(( len(CouplingB) ))
MaxEigenValImL0aK005Err = np.zeros(( len(CouplingB) ))
MaxEigenValImL0aK007Err = np.zeros(( len(CouplingB) ))
MaxEigenValImL0aK010Err = np.zeros(( len(CouplingB) ))
...
MaxEigenValImL0aK001Err = [MaxEigenValImL0g000_251Err[0],MaxEigenValImL0g000_31Err[0],MaxEigenValImL0g000_351Err[0],MaxEigenValImL0g000_41Err[0],MaxEigenValImL0g000_451Err[0],MaxEigenValImL0g000_51Err[0]]
MaxEigenValImL0aK002Err = [MaxEigenValImL0g000_251Err[1],MaxEigenValImL0g000_31Err[1],MaxEigenValImL0g000_351Err[1],MaxEigenValImL0g000_41Err[1],MaxEigenValImL0g000_451Err[1],MaxEigenValImL0g000_51Err[1]]
MaxEigenValImL0aK003Err = [MaxEigenValImL0g000_251Err[2],MaxEigenValImL0g000_31Err[2],MaxEigenValImL0g000_351Err[2],MaxEigenValImL0g000_41Err[2],MaxEigenValImL0g000_451Err[2],MaxEigenValImL0g000_51Err[2]]
MaxEigenValImL0aK005Err = [MaxEigenValImL0g000_251Err[3],MaxEigenValImL0g000_31Err[3],MaxEigenValImL0g000_351Err[3],MaxEigenValImL0g000_41Err[3],MaxEigenValImL0g000_451Err[3],MaxEigenValImL0g000_51Err[3]]
MaxEigenValImL0aK007Err = [MaxEigenValImL0g000_251Err[4],MaxEigenValImL0g000_31Err[4],MaxEigenValImL0g000_351Err[4],MaxEigenValImL0g000_41Err[4],MaxEigenValImL0g000_451Err[4],MaxEigenValImL0g000_51Err[4]]
MaxEigenValImL0aK010Err = [MaxEigenValImL0g000_251Err[5],MaxEigenValImL0g000_31Err[5],MaxEigenValImL0g000_351Err[5],MaxEigenValImL0g000_41Err[5],MaxEigenValImL0g000_451Err[5],MaxEigenValImL0g000_51Err[5]]
...
MaxEigenValImL2aK001Err = np.zeros(( len(CouplingC) ))
MaxEigenValImL2aK002Err = np.zeros(( len(CouplingC) ))
MaxEigenValImL2aK003Err = np.zeros(( len(CouplingC) ))
MaxEigenValImL2aK005Err = np.zeros(( len(CouplingC) ))
MaxEigenValImL2aK007Err = np.zeros(( len(CouplingC) ))
MaxEigenValImL2aK010Err = np.zeros(( len(CouplingC) ))
...
MaxEigenValImL2aK001Err = [MaxEigenValImL2g000_51Err[0],MaxEigenValImL2g000_61Err[0],MaxEigenValImL2g000_71Err[0],MaxEigenValImL2g000_81Err[0],MaxEigenValImL2g000_91Err[0]]
MaxEigenValImL2aK002Err = [MaxEigenValImL2g000_51Err[1],MaxEigenValImL2g000_61Err[1],MaxEigenValImL2g000_71Err[1],MaxEigenValImL2g000_81Err[1],MaxEigenValImL2g000_91Err[1]]
MaxEigenValImL2aK003Err = [MaxEigenValImL2g000_51Err[2],MaxEigenValImL2g000_61Err[2],MaxEigenValImL2g000_71Err[2],MaxEigenValImL2g000_81Err[2],MaxEigenValImL2g000_91Err[2]]
MaxEigenValImL2aK005Err = [MaxEigenValImL2g000_51Err[3],MaxEigenValImL2g000_61Err[3],MaxEigenValImL2g000_71Err[3],MaxEigenValImL2g000_81Err[3],MaxEigenValImL2g000_91Err[3]]
MaxEigenValImL2aK007Err = [MaxEigenValImL2g000_51Err[4],MaxEigenValImL2g000_61Err[4],MaxEigenValImL2g000_71Err[4],MaxEigenValImL2g000_81Err[4],MaxEigenValImL2g000_91Err[4]]
MaxEigenValImL2aK010Err = [MaxEigenValImL2g000_51Err[5],MaxEigenValImL2g000_61Err[5],MaxEigenValImL2g000_71Err[5],MaxEigenValImL2g000_81Err[5],MaxEigenValImL2g000_91Err[5]]
...
for m1 in range(0,len(CouplingB)):
    ...
    fileL0.write("\t"),
    fileL0.write("%s" % ( (MaxEigenValImL0aK001Err[m1]) ))
    fileL0.write('\n'),
for m1 in range(0,len(CouplingB)):
    fileL0.write("%s" % ( 2 )),
    fileL0.write("\t"),
    ...
    fileL0.write("\t"),
    fileL0.write("%s" % ( (MaxEigenValImL0aK002Err[m1]) ))
    fileL0.write('\n'),
for m1 in range(0,len(CouplingB)):
    fileL0.write("%s" % ( 3 )),
    fileL0.write("\t"),
    ...
    fileL0.write("\t"),
    fileL0.write("%s" % ( (MaxEigenValImL0aK003Err[m1]) ))
    fileL0.write('\n'),
for m1 in range(0,len(CouplingB)):
    fileL0.write("%s" % ( 5 )),
    fileL0.write("\t"),
    ...
    fileL0.write("\t"),
    fileL0.write("%s" % ( (MaxEigenValImL0aK005Err[m1]) ))
    fileL0.write('\n'),
for m1 in range(0,len(CouplingB)):
    fileL0.write("%s" % ( 7 )),
    fileL0.write("\t"),
    ...
    fileL0.write("\t"),
    fileL0.write("%s" % ( (MaxEigenValImL0aK007Err[m1]) ))
    fileL0.write('\n'),
for m1 in range(0,len(CouplingB)):
    fileL0.write("%s" % ( 10 )),
    fileL0.write("\t"),
    ...
    fileL0.write("\t"),
    fileL0.write("%s" % ( (MaxEigenValImL0aK010Err[m1]) ))
    fileL0.write('\n'),
fileL0.close() 
...
for m1 in range(0,len(CouplingC)):
    ...
    fileL2.write("\t"),
    fileL2.write("%s" % ( (MaxEigenValImL2aK001Err[m1]) ))
    fileL2.write('\n'),
for m1 in range(0,len(CouplingC)):
    fileL2.write("%s" % ( 2 )),
    fileL2.write("\t"),
    ...
    fileL2.write("\t"),
    fileL2.write("%s" % ( (MaxEigenValImL2aK002Err[m1]) ))
    fileL2.write('\n'),
for m1 in range(0,len(CouplingC)):
    fileL2.write("%s" % ( 3 )),
    fileL2.write("\t"),
    ...
    fileL2.write("\t"),
    fileL2.write("%s" % ( (MaxEigenValImL2aK003Err[m1]) ))
    fileL2.write('\n'),
for m1 in range(0,len(CouplingC)):
    fileL2.write("%s" % ( 5 )),
    fileL2.write("\t"),
    ...
    fileL2.write("\t"),
    fileL2.write("%s" % ( (MaxEigenValImL2aK005Err[m1]) ))
    fileL2.write('\n'),
for m1 in range(0,len(CouplingC)):
    fileL2.write("%s" % ( 7 )),
    fileL2.write("\t"),
    ...
    fileL2.write("\t"),
    fileL2.write("%s" % ( (MaxEigenValImL2aK007Err[m1]) ))
    fileL2.write('\n'),
for m1 in range(0,len(CouplingC)):
    fileL2.write("%s" % ( 10 )),
    fileL2.write("\t"),
    ...
    fileL2.write("\t"),
    fileL2.write("%s" % ( (MaxEigenValImL2aK010Err[m1]) ))
    fileL2.write('\n'),
fileL2.close() 
