...
CouplingAxis = np.linspace(0,5.0,51,endpoint=True)
CouplingAxisA= np.linspace(0,2.5,51,endpoint=True)
...
axs[0].plot(CouplingB,[MaxEigenValImL0g000_21Inf[0],MaxEigenValImL0g000_251Inf[0],MaxEigenValImL0g000_31Inf[0],MaxEigenValImL0g000_41Inf[0],MaxEigenValImL0g000_51Inf[0]], marker='*',c=[0.0, 0.0, 0.0],ls='None',markersize=4, linewidth=1)#,markeredgecolor=[1.0*1.0, 0.0*1.0, 0.0*1.0])#,label='100')
axs[0].plot(CouplingB,[MaxEigenValImL0g000_21Inf[1],MaxEigenValImL0g000_251Inf[1],MaxEigenValImL0g000_31Inf[1],MaxEigenValImL0g000_41Inf[1],MaxEigenValImL0g000_51Inf[1]], marker='*',c=[0.0, 0.0, 0.0],ls='None',markersize=4, linewidth=1)#,markeredgecolor=[1.0*1.0, 0.5*1.0, 0.0*1.0])#,label='100')
axs[0].plot(CouplingB,[MaxEigenValImL0g000_21Inf[2],MaxEigenValImL0g000_251Inf[2],MaxEigenValImL0g000_31Inf[2],MaxEigenValImL0g000_41Inf[2],MaxEigenValImL0g000_51Inf[2]], marker='*',c=[0.0, 0.0, 0.0],ls='None',markersize=4, linewidth=1)#,markeredgecolor=[0.0*1.0, 1.0*1.0, 0.0*1.0])#,label='100')
axs[0].plot(CouplingB,[MaxEigenValImL0g000_21Inf[3],MaxEigenValImL0g000_251Inf[3],MaxEigenValImL0g000_31Inf[3],MaxEigenValImL0g000_41Inf[3],MaxEigenValImL0g000_51Inf[3]], marker='*',c=[0.0, 0.0, 0.0],ls='None',markersize=4, linewidth=1)#,markeredgecolor=[0.0*1.0, 0.4*1.0, 1.0*1.0])#,label='100')

FitaK001, CovaK001 = curve_fit(func, CouplingB, [MaxEigenValImL0g000_21Inf[0],MaxEigenValImL0g000_251Inf[0],MaxEigenValImL0g000_31Inf[0],MaxEigenValImL0g000_41Inf[0],MaxEigenValImL0g000_51Inf[0]])
FitaK002, CovaK002 = curve_fit(func, CouplingB, [MaxEigenValImL0g000_21Inf[0],MaxEigenValImL0g000_251Inf[1],MaxEigenValImL0g000_31Inf[1],MaxEigenValImL0g000_41Inf[1],MaxEigenValImL0g000_51Inf[1]])
FitaK005, CovaK005 = curve_fit(func, CouplingB, [MaxEigenValImL0g000_21Inf[0],MaxEigenValImL0g000_251Inf[2],MaxEigenValImL0g000_31Inf[2],MaxEigenValImL0g000_41Inf[2],MaxEigenValImL0g000_51Inf[2]])
FitaK010, CovaK010 = curve_fit(func, CouplingB, [MaxEigenValImL0g000_21Inf[0],MaxEigenValImL0g000_251Inf[3],MaxEigenValImL0g000_31Inf[3],MaxEigenValImL0g000_41Inf[3],MaxEigenValImL0g000_51Inf[3]])
...
axs[0].grid(True)
axs[0].set_xlim(-0.e+0,+5.2e+0)
axs[0].set_xticks(np.arange(-0.0e+1,+5.01e+0, step=1.e-0))
...
axs[1].grid(True)
axs[1].set_xlim(-0.e+0,+2.6e+0)
axs[1].set_xticks(np.arange(-0.0e+1,+2.51e+0, step=5.e-1))
...
#plt.show()
fig.savefig('PlotReportTotalwithNotMatches.pdf')
