...
datag000_25a001 = np.genfromtxt('./L0gK000_25.txt')
...
datag000_30a001 = np.genfromtxt('./L0gK000_30.txt')
...
datag000_35a001 = np.genfromtxt('./L0gK000_35.txt')
...
datag000_40a001 = np.genfromtxt('./L0gK000_40.txt')
...
datag000_45a001 = np.genfromtxt('./L0gK000_45.txt')
...
datag000_50a001 = np.genfromtxt('./L0gK000_50.txt')
...
datag001_00a001 = np.genfromtxt('./L0gK001_00.txt')
...
datag002_00a001 = np.genfromtxt('./L0gK002_00.txt')
...
datag005_00a001 = np.genfromtxt('./L0gK005_00.txt')
...
datag010_00a001 = np.genfromtxt('./L0gK010_00.txt')
...
plt.clf()
fig, axs = plt.subplots(5, 2, figsize=(5, 10), sharex=True)
...
axs[0,0].set_ylim(bottom=10e-11)
...
axs[0,0].set_title("$g_{\\mathcal{K}}= 0.25$" ,fontsize=14, fontname='Times New Roman')
axs[0,1].set_title("$g_{\\mathcal{K}}= 0.30$" ,fontsize=14, fontname='Times New Roman')
axs[1,0].set_title("$g_{\\mathcal{K}}= 0.35$" ,fontsize=14, fontname='Times New Roman')
axs[1,1].set_title("$g_{\\mathcal{K}}= 0.40$" ,fontsize=14, fontname='Times New Roman')
axs[2,0].set_title("$g_{\\mathcal{K}}= 0.45$" ,fontsize=14, fontname='Times New Roman')
axs[2,1].set_title("$g_{\\mathcal{K}}= 0.50$" ,fontsize=14, fontname='Times New Roman')
axs[3,0].set_title("$g_{\\mathcal{K}}= 1$" ,fontsize=14, fontname='Times New Roman')
axs[3,1].set_title("$g_{\\mathcal{K}}= 2$" ,fontsize=14, fontname='Times New Roman')
axs[4,0].set_title("$g_{\\mathcal{K}}= 5$" ,fontsize=14, fontname='Times New Roman')
