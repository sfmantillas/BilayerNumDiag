...
fiveSizes = [1./40,1./50,1./60,1./70,1./80]

###############################################
###############################################
###############################################

data0010011010 = np.genfromtxt('./aK001/N040/HamVals.txt')
...
data0010011020 = np.genfromtxt('./aK001/N050/HamVals.txt')
...
data0010011030 = np.genfromtxt('./aK001/N060/HamVals.txt')
...
data0010011040 = np.genfromtxt('./aK001/N070/HamVals.txt')
...
data0010011050 = np.genfromtxt('./aK001/N080/HamVals.txt')
...
data0010021010 = np.genfromtxt('./aK002/N040/HamVals.txt')
...
data0010021020 = np.genfromtxt('./aK002/N050/HamVals.txt')
...
data0010021030 = np.genfromtxt('./aK002/N060/HamVals.txt')
...
data0010021040 = np.genfromtxt('./aK002/N070/HamVals.txt')
...
data0010021050 = np.genfromtxt('./aK002/N080/HamVals.txt')
...
data0010051010 = np.genfromtxt('./aK005/N040/HamVals.txt')
...
data0010051020 = np.genfromtxt('./aK005/N050/HamVals.txt')
...
data0010051030 = np.genfromtxt('./aK005/N060/HamVals.txt')
...
data0010051040 = np.genfromtxt('./aK005/N070/HamVals.txt')
...
data0010051050 = np.genfromtxt('./aK005/N080/HamVals.txt')
...
data0010101010 = np.genfromtxt('./aK010/N040/HamVals.txt')
...
data0010101020 = np.genfromtxt('./aK010/N050/HamVals.txt')
...
data0010101030 = np.genfromtxt('./aK010/N060/HamVals.txt')
...
data0010101040 = np.genfromtxt('./aK010/N070/HamVals.txt')
...
data0010101050 = np.genfromtxt('./aK010/N080/HamVals.txt')
...
print EigenValIm0010011010[400]
print EigenValIm0010011020[500]
print EigenValIm0010011030[600]
print EigenValIm0010011040[700]
print EigenValIm0010011050[800]
print MaxEigenValIm0011Inf

plt.semilogy(MomentumAx0010011010[400],EigenValIm0010011010[400], marker='^',c=[1.0, 0.0, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011020[500],EigenValIm0010011020[500], marker='s',c=[1.0, 0.0, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011030[600],EigenValIm0010011030[600], marker='p',c=[1.0, 0.0, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011040[700],EigenValIm0010011040[700], marker='h',c=[1.0, 0.0, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011050[800],EigenValIm0010011050[800], marker='8',c=[1.0, 0.0, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(                             [0],[MaxEigenValIm0011Inf[0]], marker='o',c=[1.0, 0.0, 0.0],ls='None', markersize=5,label='$a_{\\mathcal{K}}= 1$', markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])

print EigenValIm0010021010[400]
print EigenValIm0010021020[500]
print EigenValIm0010021030[600]
print EigenValIm0010021040[700]
print EigenValIm0010021050[800]


plt.plot(MomentumAx0010011010[400],EigenValIm0010021010[400], marker='^',c=[1.0, 0.5, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011020[500],EigenValIm0010021020[500], marker='s',c=[1.0, 0.5, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011030[600],EigenValIm0010021030[600], marker='p',c=[1.0, 0.5, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011040[700],EigenValIm0010021040[700], marker='h',c=[1.0, 0.5, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011050[800],EigenValIm0010021050[800], marker='8',c=[1.0, 0.5, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(                             [0],[MaxEigenValIm0011Inf[1]], marker='o',c=[1.0, 0.5, 0.0],ls='None', markersize=5,label='$a_{\\mathcal{K}}= 2$', markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])

plt.plot(MomentumAx0010011010[400],EigenValIm0010051010[400], marker='^',c=[0.0, 1.0, 0.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011020[500],EigenValIm0010051020[500], marker='s',c=[0.0, 1.0, 0.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011030[600],EigenValIm0010051030[600], marker='p',c=[0.0, 1.0, 0.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011040[700],EigenValIm0010051040[700], marker='h',c=[0.0, 1.0, 0.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(MomentumAx0010011050[800],EigenValIm0010051050[800], marker='8',c=[0.0, 1.0, 0.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(                             [0],[MaxEigenValIm0011Inf[2]], marker='o',c=[0.0, 1.0, 0.0],ls='None', markersize=5,label='$a_{\\mathcal{K}}= 5$', markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])

plt.plot(MomentumAx0010101010[400],EigenValIm0010101010[400], marker='^',c=[0.0, 0.0, 1.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(MomentumAx0010101020[500],EigenValIm0010101020[500], marker='s',c=[0.0, 0.0, 1.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(MomentumAx0010101030[600],EigenValIm0010101030[600], marker='p',c=[0.0, 0.0, 1.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(MomentumAx0010101040[700],EigenValIm0010101040[700], marker='h',c=[0.0, 0.0, 1.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(MomentumAx0010101050[800],EigenValIm0010101050[800], marker='8',c=[0.0, 0.0, 1.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(                             [0],[MaxEigenValIm0011Inf[3]], marker='o',c=[0.0, 0.0, 1.0],ls='None', markersize=5,label='$a_{\\mathcal{K}}= 10$',markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])

plt.grid(True)
#plt.xlim(-0.0e+1,+2.0e+1)
#plt.set_xticks(np.arange(-0.0e+1,+2.01e+1, step=4.e-0))
#plt.set_ylim(1e-0,+1e+3)
...
#plt.set_xlabel('$k/\\mathcal{K}\\times 10^{+5}$', fontsize=12, fontname='Times New Roman')
#plt.set_ylabel('Im[$E(k)$]$/E_{\\mathrm{UV}}\\times 10^{+5}$', fontsize=12, fontname='Times New Roman')
...
#plt.show()
plt.savefig('PlotsReportgK000-25.pdf')
