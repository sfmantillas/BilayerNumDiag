...
data0010011010 = np.genfromtxt('./aK001/N010/HamVals.txt')
...
data0010011020 = np.genfromtxt('./aK001/N020/HamVals.txt')
...
data0010011030 = np.genfromtxt('./aK001/N030/HamVals.txt')
...
data0010011040 = np.genfromtxt('./aK001/N040/HamVals.txt')
...
data0010011050 = np.genfromtxt('./aK001/N050/HamVals.txt')
...
plt.plot(1*MomentumAx0010011010[100],1*EigenValIm0010011010[100], marker='^',c=[1.0, 0.0, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011020[200],1*EigenValIm0010011020[200], marker='s',c=[1.0, 0.0, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011030[300],1*EigenValIm0010011030[300], marker='p',c=[1.0, 0.0, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011040[400],1*EigenValIm0010011040[400], marker='h',c=[1.0, 0.0, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011050[500],1*EigenValIm0010011050[500], marker='8',c=[1.0, 0.0, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.0*0.8, 0.0*0.8])
...
plt.plot(1*MomentumAx0010021010[100],1*EigenValIm0010021010[100], marker='^',c=[1.0, 0.5, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010021020[200],1*EigenValIm0010021020[200], marker='s',c=[1.0, 0.5, 0.0],ls='None', markersize=5,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010021030[300],1*EigenValIm0010021030[300], marker='p',c=[1.0, 0.5, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010021040[400],1*EigenValIm0010021040[400], marker='h',c=[1.0, 0.5, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010021050[500],1*EigenValIm0010021050[500], marker='8',c=[1.0, 0.5, 0.0],ls='None', markersize=6,markeredgecolor=[1.0*0.8, 0.5*0.8, 0.0*0.8])
...
plt.plot(1*MomentumAx0010011010[100],1*EigenValIm0010051010[100], marker='^',c=[0.0, 1.0, 0.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011020[200],1*EigenValIm0010051020[200], marker='s',c=[0.0, 1.0, 0.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011030[300],1*EigenValIm0010051030[300], marker='p',c=[0.0, 1.0, 0.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011040[400],1*EigenValIm0010051040[400], marker='h',c=[0.0, 1.0, 0.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
plt.plot(1*MomentumAx0010011050[500],1*EigenValIm0010051050[500], marker='8',c=[0.0, 1.0, 0.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 1.0*0.8, 0.0*0.8])
...
plt.plot(1*MomentumAx0010101010[100],1*EigenValIm0010101010[100], marker='^',c=[0.0, 0.0, 1.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(1*MomentumAx0010101020[200],1*EigenValIm0010101020[200], marker='s',c=[0.0, 0.0, 1.0],ls='None', markersize=5,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(1*MomentumAx0010101030[300],1*EigenValIm0010101030[300], marker='p',c=[0.0, 0.0, 1.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(1*MomentumAx0010101040[400],1*EigenValIm0010101040[400], marker='h',c=[0.0, 0.0, 1.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
plt.plot(1*MomentumAx0010101050[500],1*EigenValIm0010101050[500], marker='8',c=[0.0, 0.0, 1.0],ls='None', markersize=6,markeredgecolor=[0.0*0.8, 0.0*0.8, 1.0*0.8])
