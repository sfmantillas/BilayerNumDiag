...
XXX = 1000000.             #Amplification of the Hamiltonian
...
for i in range(0,NNN*SSS):
    ...
    for j in range(0,i+1):
        ...
        if i==j:
            ...
            HamiltonMatrix[i+000][j+000] = XXX*( Kin_Term(Mom,EUV,KKK,NNN,MMM) + SelfEnergy(Mom,EUV,KKK,NNN,MMM,GGG,AAA) )
            ...
            #Hopping terms 
            HamiltonMatrix[i+000][j+000] = XXX*( Four_Hopp_Pair(Mom1,Mom2,LLL,EUV,KKK,GGG,AAA,MMM,+1)*np.sqrt( Jacobi(mx,KKK,NNN,RRR)*Jacobi(my,KKK,NNN,RRR) ) )
            ...
            #Pairing terms
            HamiltonMatrix[i+000][j+NNN*SSS] = XXX*( Four_Hopp_Pair(Mom1,Mom2,LLL,EUV,KKK,GGG,AAA,MMM,-1)*np.sqrt( Jacobi(mx,KKK,NNN,RRR)*Jacobi(my,KKK,NNN,RRR) ) )
...
#HamiltonEigVals, HamiltonEigVecs = LA.schur( HamiltonMatrix )
HamiltonEigVals = LA.eigvals( HamiltonMatrix )/XXX
